...
<img src='https://github.com/marilymaril/twitterApp/blob/master/altTwitter.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- [X] User can view their profile in a profile tab: Contains the user header view: picture and tagline, and Contains a section with the users basic stats: # tweets, # following, # followers
...
- [X] I added the timeline for any profile that is clicked, including the current user.
-

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. I would like to see how my peers did with this assigment
2. I would like to discuss what other features would be cool to add that the app has, and if anyone tried to implement them.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/marilymaril/twitterApp/blob/master/altTwitter2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
